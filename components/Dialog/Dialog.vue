<template>
	<view class="dialog-content" v-if="hasVerification">
			...
			<view class="dialog-bg-box d-flex flex-cloumn justify-between">
				<view class="">
					...
					<view class="inner-box">
						<view class="text-center fill-in">请先填写您邀请人的ID号</view>
		...
		<u-keyboard mode="number" :dotDisabled="true" :show="showkeyboard" :showTips="false" :overlay="false"
			@cancel="showkeyboard = false" @change="valChange" @confirm="confirmIdentify"></u-keyboard>
	</view>
</template>
...
<style lang="scss" scoped>
	.dialog-content {
		.dialog-mask {
			...
			.dialog-bg-box {
				background: url('@/static/images/bedding/dialog.png');
